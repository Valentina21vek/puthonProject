...
num1 = 2
num2 = 30
# if num1 < num2: #'expression is true'
if num1 == num2: # comparing 2 values using == "expression is false"
    print('expression is true')
    print("you can do something here")
else:     # Only 1 false case can be generated
    print("expression is false")

print('if expression complete here')
...
if msg:
    ...
    print("expression is false")
print("----------fourth---------------")
nums = [45, 4, 5, 6, 3, 10, 5, 123, 346, 4, 5, 666, 5] # this is considered as True
count = 0
...
new_users = ['mia', 'sara', 'jhon','stanley']

for user in new_users:
    if user == 'stanley':
        print(f"Hi {user}, glad to see you!")